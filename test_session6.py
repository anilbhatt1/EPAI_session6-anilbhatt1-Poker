...
def royal_flush_1():
    ...
    output = session5.winner(hand_1, hand_2)
...
def flush_18():
    hand_1 = ['h-10', 'h-9', 'H-8', 'h-j']
    hand_2 = ['s-10', 's-9', 's-8', 's-j']
    output = session5.winner(hand_1, hand_2)
    assert output == 'Flush ** Player 2 won !', 'Incorrect Result'   
