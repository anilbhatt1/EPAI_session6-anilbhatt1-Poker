...
def call_lambda(fn, suites, cards):
    return list(sorted(map(fn, suites*13,cards*4)))
...
def winner(hand_1, hand_2):
    ...
    if len(hand1) == len(hand2) and (len(hand1) == 3 or len(hand1) == 4 or len(hand1) == 5):
        ...
        if cnt == 4 or hand1_rank_temp.count(hand1_rank_temp[1]) == 4:
            ...
            hand1_full_house = 1
        elif cnt == 3 or hand1_rank_temp.count(hand1_rank_temp[1]) == 3 or hand1_rank_temp.count(hand1_rank_temp[2]) ==3:
            hand1_3_of_kind = 1  
       ...
       # Hand 1 -> Identifying 2-pairs, 1-pair
        ...
        if cnt == 4 or hand2_rank_temp.count(hand2_rank_temp[1]) == 4:
            ...
            hand2_full_house = 1
        elif cnt == 3 or hand2_rank_temp.count(hand2_rank_temp[1]) == 3 or hand2_rank_temp.count(hand2_rank_temp[2]) ==3:
            hand2_3_of_kind = 1
